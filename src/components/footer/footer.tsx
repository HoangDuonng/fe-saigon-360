...
export default function Footer() {
    ...
    return (
        <div>
            <footer className="flex flex-wrap bg-yellow text-center mt-20 md:justify-center md:p-20">
                    ...
                    <Link href='/' passHref>
                        <div className="flex justify-center hover:cursor-pointer">
                            <div className="flex flex-col sm:flex-row justify-center sm:space-x-2 ml-1">
                                ...
                                <span className="text-xl md:text-2xl font-bold text-white ">360</span>
                            </div>
                        </div>
                    </Link>
                </div>
                <div className="flex flex-col w-full md:w-1/5 text-sm p-4 md:text-[16px] space-y-4">
                    <span className="text-black py-2 font-medium">{locale === "en" ? "Panoramas" : "Toàn cảnh"}</span>
                    {[
                        ...
                        <span key={index} className="text-gray-800  font-light py-1 hover:text-white  cursor-pointer transition-all">{item}</span>
                    ))}
                </div>

                <div className="flex flex-col w-full md:w-1/5 text-sm p-4 md:text-[16px] space-y-4">
                    <span className="text-black py-2 font-medium">{locale === "en" ? "University" : "Trường đại học"}</span>
                    {[
                ...
                <div className="flex flex-col w-full md:w-1/5 text-sm p-4 md:text-[16px] space-y-4">
                    <span className="text-black py-2 font-medium">{locale === "en" ? "Have a question?" : "Có câu hỏi nào?"}</span>
                    <span className="text-gray-800  font-light py-1 hover:text-white  cursor-pointer transition-all">
                ...
                <div className="w-full px-6 md:px-24 pb-10 py-6">
                    ...
                    <span className="text-xs md:text-sm text-gray-800  font-light text-center block">
